...
def main():
    ...
    # load the datasets
    pretrained_seq, pretrained_lbl = build_shanghaitech_lists(pretrain_dir)
    ...
    if pretrain: 
        ...
        torch.save(model.state_dict(), "action_checkpoints/Shanghai_pretrained.pt")
    ...
    three_d = False
    t1 = load_T1(
        model_path="action_checkpoints/Shanghai_pretrained.pt",
        num_joints=NUM_JOINTS_PENN,
        three_d=three_d,
        d_model=hidden_size,
        nhead=n_heads,
